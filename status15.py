...
album = escape_quotes("".join(currentsong.get("album", "")) if isinstance(currentsong.get("album", ""), list) else currentsong.get("album", ""))
...
next_album = ", ".join([escape_quotes(g) for g in nextsong.get("album", [])]) if isinstance(nextsong.get("album", ""), list) else escape_quotes(nextsong.get("album", ""))
...
songpos='{song_position}'
song_length='{song_length}'
pllength='{song_length}'
elapsed='{elapsed}'
total_time='{total_time}'
duration='{total_time}'
percent_time='{percent_time_formatted}'
percent='{percent_time_formatted}'
filepath='{filepath}'
title='{title}'
artist='{artist}'
